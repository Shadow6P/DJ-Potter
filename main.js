...
function draw() {
    ...
    if (scoreizquierda > 0.2) {
        ...
        if (muñecaizquierday > 0 && muñecaizquierday < 100) {
            document.getElementById("volumen").innerHTML = "Volume = 1";
            deson.setVolume(1);
        }
        if (muñecaizquierday > 100 && muñecaizquierday < 200) {
            document.getElementById("volumen").innerHTML = "Volume = 0.8";
            deson.setVolume(0.8);
        }
        if (muñecaizquierday > 200 && muñecaizquierday < 300) {
            document.getElementById("volumen").innerHTML = "Volume = 0.6";
            deson.setVolume(0.6);
        }
        if (muñecaizquierday > 300 && muñecaizquierday < 400) {
            document.getElementById("volumen").innerHTML = "Volume = 0.4";
            deson.setVolume(0.4);
        }
        if (muñecaizquierday > 400 && muñecaizquierday < 500) {
            document.getElementById("volumen").innerHTML = "Volume = 0.2";
            deson.setVolume(0.2);
        }
    }
}
